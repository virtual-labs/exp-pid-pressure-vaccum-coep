...
//	right side sensor path from top
	...
	var connSocket1 = paper.image("images/connectorSocket.png", (x + 522), (y + 496), 20, 50);
	var butterflyValve = paper.image("images/butterfly.png", (x + 430), (y + 420), 220, 140);
	var connSocket2 = paper.image("images/connectorSocket.png", (x + 556), (y + 494), 20, 50).attr({'transform': 'r' + 180});
