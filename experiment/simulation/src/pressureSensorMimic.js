...
//	var vacuumColor = "#ddf4f6";
	...
	var eleOn = paper.image("images/green.png", (d + 225), (e-20), 40, 40);
	var eleOff = paper.image("images/red.png", (d + 225), (e-20), 40, 40);
			
	paper.text((d+30), (e+40), "Start up process : ").attr({ 'font-size': 17, 'font-weight': 'bold','text-anchor': 'start'  });
	var stOn = paper.image("images/green.png", (d + 225), (e+20), 40, 40);
	var stOff = paper.image("images/red.png", (d + 225), (e+20), 40, 40);
			
	paper.text((d+30), (e+80), "Running Process : ").attr({ 'font-size': 17, 'font-weight': 'bold','text-anchor': 'start'  });
	var rnOn = paper.image("images/green.png", (d + 225), (e+60), 40, 40);
	var rnOff = paper.image("images/red.png", (d + 225), (e+60), 40, 40);
			
	paper.text((d+30), (e+120), "Shutdown Process : ").attr({ 'font-size': 17, 'font-weight': 'bold','text-anchor': 'start'  });
	var shOn = paper.image("images/green.png", (d + 225), (e+100), 40, 40);
	var shOff = paper.image("images/red.png", (d + 225), (e+100), 40, 40);
	...
	paper.image("images/wireless.gif", (x + 1290), (y+80), 60, 40);
	paper.image("images/wireless.gif", (x + 1360), (y+190), 60, 40);
	paper.image("images/wireless.gif", (x + 1280), (y+330), 60, 40);
	
	paper.rect((x+1420),(y-60),100,150,5);
	paper.image("images/wifiGateway.png", (x + 1430), (y-50), 80, 100).transform("s-1,1");;
	...
	paper.image("images/wireless.gif", (x + 1425), (y-49), 80, 50).attr({'transform': 'r' + 270});
...
//	right side sensor path from top
	...
	var compressorGVent = paper.image("images/svValveH2G.png", (x + 378), (y + 560), 40, 65).attr({'transform': 'r' + 90});
	var compressorRVent = paper.image("images/svValveH1R.png", (x + 378), (y + 560), 40, 65).attr({'transform': 'r' + 90});
	
	paper.image("images/compressor.png", (x + 120), (y + 350), 240, 280);
	
	var connSocket1 = paper.image("images/connectorSocket.png", (x + 505), (y + 493), 20, 55);
	var connSocket2 = paper.image("images/connectorSocket.png", (x + 567), (y + 491), 20, 55).attr({'transform': 'r' + 180});
	var controlValve = paper.image("images/controlValve.png", (x + 480), (y + 412), 120, 140);
	
	var mtrOn = paper.image("images/green.png", (x + 290), (y + 495), 50, 50);
	var mtrOff = paper.image("images/red.png", (x +290), (y + 495), 50, 50);
	...
	paper.image("images/connectorSocket.png", (x + 901), (y + 171), 20, 40).attr({'transform': 'r' + 33});
	
	paper.image("images/connectorSocket.png", (x + 1080), (y + 171), 20, 40).attr({'transform': 'r' + 148});
	
	paper.image("images/connectorSocket.png", (x + 950), (y + 130), 20, 40).attr({'transform': 'r' + 68});
	
	paper.image("images/connectorSocket.png", (x + 1033), (y + 132), 20, 40).attr({'transform': 'r' + 115});
	
	paper.image("images/connectorSocket.png", (x + 901), (y + 290), 20, 40).attr({'transform': 'r' + 327});
	
	paper.image("images/connectorSocket.png", (x + 1080), (y + 290), 20, 40).attr({'transform': 'r' + 213});
	
	paper.image("images/connectorSocket.png", (x + 950), (y + 330), 20, 40).attr({'transform': 'r' + 292});
	
	paper.image("images/connectorSocket.png", (x + 1033), (y + 328), 20, 40).attr({'transform': 'r' + 245});
	
	
//left sensor from top
	paper.image("images/capVacuum.png", (x + 745), (y-30), 130, 90);
	
	paper.image("images/capVacuum.png", (x + 665), (y+55), 130, 90);
	
	paper.image("images/capVacuum.png", (x + 585), (y+135), 130, 90);
	
	paper.image("images/capVacuum.png", (x + 665), (y+265), 130, 90);
	
	paper.image("images/capVacuum.png", (x + 708), (y+380), 130, 90);
	
//right sensor from top	
	paper.image("images/capVacuum.png", (x + 1131), (y-30), 130, 90);
	
	paper.image("images/capVacuum.png", (x + 1208), (y+55), 130, 90);
	
	paper.image("images/capVacuum.png", (x + 1285), (y+135), 130, 90);
	
	paper.image("images/capVacuum.png", (x + 1200), (y+265), 130, 90);
	

//left side valve from top
	
	var s1gValve = paper.image("images/svValveH2G.png", (x + 850), (y + 35.5), 40, 60);
	var s1rValve = paper.image("images/svValveH1R.png", (x + 850), (y + 35.5), 40, 60);
	
	var s2gValve = paper.image("images/svValveH2G.png", (x + 790), (y + 123.5), 40, 60);
	var s2rValve = paper.image("images/svValveH1R.png", (x + 790), (y + 123.5), 40, 60);
	
	var s3gValve = paper.image("images/svValveH2G.png", (x + 775), (y + 203), 40, 60);
	var s3rValve = paper.image("images/svValveH1R.png", (x + 775), (y + 203), 40, 60);
	
	var s4gValve = paper.image("images/svValveH2G.png", (x + 775), (y + 313.5), 40, 60);
	var s4rValve = paper.image("images/svValveH1R.png", (x + 775), (y + 313.5), 40, 60);
	
	var s5gValve = paper.image("images/svValveH2G.png", (x + 820), (y + 424.5), 40, 60);
	var s5rValve = paper.image("images/svValveH1R.png", (x + 820), (y + 424.5), 40, 60);
	
	
//	right side valve from top
	var s6gValve = paper.image("images/svValveH2G.png", (x + 1100), (y + 39.5), 40, 60);
	var s6rValve = paper.image("images/svValveH1R.png", (x + 1100), (y + 39.5), 40, 60);
	
	var s7gValve = paper.image("images/svValveH2G.png", (x + 1160), (y + 124.5), 40, 60);
	var s7rValve = paper.image("images/svValveH1R.png", (x + 1160), (y + 124.5), 40, 60);
	
	var s8gValve = paper.image("images/svValveH2G.png", (x + 1175), (y + 204.5), 40, 60);
	var s8rValve = paper.image("images/svValveH1R.png", (x + 1175), (y + 204.5), 40, 60);

	var s9gValve = paper.image("images/svValveH2G.png", (x + 1175), (y + 313.5), 40, 60);
	var s9rValve = paper.image("images/svValveH1R.png", (x + 1175), (y + 313.5), 40, 60);
	
	var openrVent = paper.image("images/svValveH1R.png", (x + 1140), (y + 432.5), 40, 60);
	var opengVent = paper.image("images/svValveH2G.png", (x + 1140), (y + 432.5), 40, 60);
