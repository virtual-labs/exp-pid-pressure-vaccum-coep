...
function pressureVacuumSensorInstrument()
{
	...
	htm=''
		...
		+' <input class="form-select" id="pi" type="number" min="0" max="5" value="1" tabindex="1"></input>'
		+'</div>'
		
		+'<div class="col-sm-12">'
		+'<label><b>Select no of  air filter regulator (AFR)</b></label>'
		+' <input class="form-select" id="afr" type="number" min="0" max="5" value="1" tabindex="2"></input>'
		+'</div>'
		
		+'<div class="col-sm-12">'
		+'<label><b>Select no of wireless gateway </b></label>'
		+' <input class="form-select" id="wgateway" type="number" min="0" max="5" value="1" tabindex="3"></input>'
		+'</div>'
		+'<div class="col-sm-12">'
		+'<label><b>Select no of vaccum transmitter wired </b></label>'
		+' <input class="form-select" id="vwired"  type="number" min="0" max="6" value="4" tabindex="4"></input>'
		+'</div>'
		+'<div class="col-sm-12">'
		+'<label><b>Select no of vaccum transmitter wireless </b></label>'
		+' <input class="form-select" id="vwireless"  type="number" min="0" max="7" value="1" tabindex="5" ></input>'
		+'</div>'
		+'<div class="col-sm-12">'
		+'<label><b>Select no of pressure transmitter wired</b></label>'
		+' <input class="form-select" id="ptwired" type="number" min="0" max="5" value="7" tabindex="6"></input>'
		+'</div>'
		
		+'<div class="col-sm-12">'
		+'<label><b>Select no of pressure transmitter wireless</b></label>'
		+' <input class="form-select" id="ptwireless" type="number" min="0" max="5" value="2" tabindex="7"></input>'
		+'</div>'
		
		+'<div class="col-sm-12">'
		+'<label><b>Select no of PRV auto Valve</b></label>'
		+' <input class="form-select" id="prv" type="number" min="0" max="5" value="1" tabindex="8"></input>'
		+'</div>'
